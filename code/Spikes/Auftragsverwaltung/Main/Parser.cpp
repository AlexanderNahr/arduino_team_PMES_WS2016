...
states Parser::RunParser(String ReceivedString,int Orders, int RemainingTime)
{
  ...
  if(FirstWord=="SIGN_IN")
    {
      Answer = Loginmanagement(ReceivedString_NoDelim,Orders,RemainingTime);
    }
    else if (FirstWord=="ORDER")
        {
          Answer = Ordermanagement(ReceivedString_NoDelim,Orders,RemainingTime);
          Answer = "[" + Answer + "]\n";
          //Returnvalue = 4; //BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG-BUG
        }
        else if (FirstWord=="SIGN_OUT")
            {
             Answer = Logoutmanagement(ReceivedString_NoDelim,Orders,RemainingTime); 
             Answer = "[" + Answer + "]\n";
            }
