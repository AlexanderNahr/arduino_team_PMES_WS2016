...
WiFiService::WiFiService()
{
  //Parameters:
	...
	ptrStartChar[2] = STARTZEICHEN_1;
	ptrEndChar[0] = ENDZEICHEN_1;
	ptrEndChar[1] = ENDZEICHEN_1;
	ptrEndChar[2] = ENDZEICHEN_1;
...
// Test Command Mode: Es wird nur HWtoSWSerial(); aufgerufen
...
// Test Command Mode: Neu!
void WiFiService::CMD_Enter()
{
    byte mes[] = {0x24, 0x24, 0x24}; // $ $ $

  mySerial.write(mes, sizeof(mes));

}

// Test Command Mode: Neu!
void WiFiService::CMD_Exit()
{
  byte sage[] = {0x65, 0x78, 0x69, 0x74, 0x0D ,0x0A }; // e x i t \cr \n

  mySerial.write(sage, sizeof(sage));
...
// Test Command Mode: Code wurde angepasst!
