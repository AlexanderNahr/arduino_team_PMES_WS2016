...
class Parser
{
  ...
  states RunParser(char CharArr[],int Orders, int RemainingTime);
  ...
  String Loginmanagement(char *p, int Orders, int Time);
  String Logoutmanagement();
  String Ordermanagement(char *p, int Orders, int Time);
  String Broadcastmanagement();
  bool CheckString(char *p);
};
